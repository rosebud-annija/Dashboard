 ...
 * Zuletzt gespeichert: 12.6.2026, 12:56:37
 */

const PANEL_TEXTE = {

  "Bevölkerung": {
    e: "Österreichs Bevölkerung ist auf rund 9,19 Millionen Menschen angewachsen und setzt damit einen langfristigen Wachstumstrend fort. Dieses Wachstum ist jedoch fast ausschließlich auf Zuwanderung zurückzuführen, da die natürliche Bevölkerungsentwicklung – also Geburten minus Sterbefälle – seit Jahren negativ ist. Für die Sozialsysteme bedeutet das: Ohne Zuwanderung würde die Erwerbsbevölkerung schrumpfen, was den ohnehin hohen Druck auf Pensionen und Gesundheitsversorgung weiter verschärfen würde. Entscheidend ist dabei, wie gut Zugewanderte in den Arbeitsmarkt integriert werden, denn nur Erwerbstätigkeit sichert die Finanzierungsbasis des Sozialstaats.",
    vt: "Bevölkerung",
